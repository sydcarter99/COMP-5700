...
class Test(unittest.TestCase):
    ...
    def test020_solves_cube_with_top_cross_solved(self):
        inputDict = {}
        inputDict['op'] = 'solve'
        inputDict['cube'] = 'grooooooobgbbbbbbbrbgrrrrrroorggggggyyyyyyyyywwwwwwwww'
    ...
    def test030_solves_top_cross(self):
        inputDict = {}
        inputDict['op'] = 'solve'
        ...
        expectedResult['top']    = (inputDict.get('cube')[40]) * 5
        ...
        actualResult['top']    = cube[37]+cube[39:42]+cube[43]
        
        self.assertEqual(expectedResult, actualResult)
        self.assertEqual('ok', solvedCube.get('status'))
        
    def test040_solves_top_cross(self):
        inputDict = {}
        inputDict['op'] = 'solve'
    ...
    def test050_solves_bottom_layers_and_top_cross(self):
        inputDict = {}
        inputDict['op'] = 'solve'
